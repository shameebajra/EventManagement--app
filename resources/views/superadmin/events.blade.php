                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="p-4 whitespace-nowrap text-sm font-normal text-gray-500">
                                ...
                                <img class="h-10 w-10 rounded-full" src="{{asset('/images/eventPoster/'. $event->poster )}}" alt="poster">
                            ...
                            <td class="p-4 whitespace-nowrap space-x-2">
                               <!-- Link to show event details -->
                                <a href="{{route('superadmin.event.detail',$event->id)}}" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
