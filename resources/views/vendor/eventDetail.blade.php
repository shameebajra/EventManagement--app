    ...
    <div class="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-6">
      ...
      <div class="flex space-x-8">
        ...
        <div class="w-1/3 bg-gray-50 p-4 rounded-lg">
          <img src="https://via.placeholder.com/150" alt="Profile Image" class="rounded-full w-32 h-32 mx-auto mb-4">
          <div class="text-center">
            <h1 class="text-xl font-bold">Jese Leos</h1>
          ...
          <div class="mt-6 text-sm">
            ...
            <p><strong>Home address:</strong> 92 Miles Drive, Newark, NJ 07103, California, USA</p>
