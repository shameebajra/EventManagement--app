                        ...
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="p-4 whitespace-nowrap space-x-2">
                               <!-- Link to show event details -->
                                <a href="{{route('event.detail',$event->id)}}" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
